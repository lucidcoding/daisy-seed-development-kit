#pragma once
#ifndef STEPPED_POTENTIOMETER_ARRAY_PAGE_ITEM_H
#define STEPPED_POTENTIOMETER_ARRAY_PAGE_ITEM_H
...
namespace developmentKit::library::uiFramework::tabs::presenters
{
    ...
    class SteppedPotentiometerArrayPageItem : public PotentiometerArrayPageItem
    {
    public:
        SteppedPotentiometerArrayPageItem();
        ~SteppedPotentiometerArrayPageItem() {}
