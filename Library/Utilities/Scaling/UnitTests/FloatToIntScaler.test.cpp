...
TEST_CASE("Calling Scale on positive scale returns correct values")
{
    ...
    scaler.Init(0, 99, FloatToIntScaler::LINEAR);
...
{
    FloatToIntScaler scaler;
    scaler.Init(0, 4, FloatToIntScaler::LINEAR);
    REQUIRE(scaler.Scale(0.00005f) == 0);
...
{
    FloatToIntScaler scaler;
    scaler.Init(100, 199, FloatToIntScaler::LINEAR);
...
{
    FloatToIntScaler scaler;
    scaler.Init(-2, 2, FloatToIntScaler::LINEAR);
